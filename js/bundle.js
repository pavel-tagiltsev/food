...
/* harmony default export */ __webpack_exports__["default"] = (cards); // Another method
// function cards() { 
...
function slider({
  ...
  slider.style.position = 'relative'; // Create a panel for dots
  ...
  indicators.style.cssText = `
        ...
        list-style: none;
        `;
  slider.append(indicators); // Create dots
...
/* harmony default export */ __webpack_exports__["default"] = (slider); //My variat
//  function slider(){
...
function timer(id, deadline) {
  ...
  function showDateEnd(deadline) {
    ...
    document.querySelector("[data-date-end]").textContent = `${days} ${month} в ${getZero(hours)}:${getZero(mins)}`;
  }
